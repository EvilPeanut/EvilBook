...
public class Session implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args) {
		...
		if (command.getName().equalsIgnoreCase("desel")) {	
		...
		if (command.getName().equalsIgnoreCase("pyramid")) {	
			Generation.createPyramid(player, args, false);
			return true;
		}
		if (command.getName().equalsIgnoreCase("hpyramid")) {	
		...
		if (command.getName().equalsIgnoreCase("esphere")) {	
